...
class ProfesorsTest < ApplicationSystemTestCase
  ...
  test "creating a Profesor" do
    ...
    fill_in "Fecha contrato", with: @profesor.fecha_contrato
    fill_in "Grado academido", with: @profesor.grado_academido
    fill_in "Titulo", with: @profesor.titulo
    fill_in "Usuario", with: @profesor.usuario_id
