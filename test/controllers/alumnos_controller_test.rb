...
class AlumnosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create alumno" do
    assert_difference('Alumno.count') do
      post alumnos_url, params: { alumno: { credito_obtenido: @alumno.credito_obtenido, usuario_id: @alumno.usuario_id } }
    end
  ...
  test "should update alumno" do
    patch alumno_url(@alumno), params: { alumno: { credito_obtenido: @alumno.credito_obtenido, usuario_id: @alumno.usuario_id } }
