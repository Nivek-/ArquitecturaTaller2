...
class ProfesorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create profesor" do
    assert_difference('Profesor.count') do
      post profesors_url, params: { profesor: { fecha_contrato: @profesor.fecha_contrato, grado_academido: @profesor.grado_academido, titulo: @profesor.titulo, usuario_id: @profesor.usuario_id } }
    end
  ...
  test "should update profesor" do
    patch profesor_url(@profesor), params: { profesor: { fecha_contrato: @profesor.fecha_contrato, grado_academido: @profesor.grado_academido, titulo: @profesor.titulo, usuario_id: @profesor.usuario_id } }
