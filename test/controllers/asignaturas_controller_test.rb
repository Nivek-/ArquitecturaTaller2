...
class AsignaturasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create asignatura" do
    assert_difference('Asignatura.count') do
      post asignaturas_url, params: { asignatura: { creditos: @asignatura.creditos, departamento_id: @asignatura.departamento_id, nombre: @asignatura.nombre, profesor_id: @asignatura.profesor_id } }
    end
  ...
  test "should update asignatura" do
    patch asignatura_url(@asignatura), params: { asignatura: { creditos: @asignatura.creditos, departamento_id: @asignatura.departamento_id, nombre: @asignatura.nombre, profesor_id: @asignatura.profesor_id } }
