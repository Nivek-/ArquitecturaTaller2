...
class AulasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create aula" do
    assert_difference('Aula.count') do
      post aulas_url, params: { aula: { edificio: @aula.edificio, numero_aula: @aula.numero_aula } }
    end
  ...
  test "should update aula" do
    patch aula_url(@aula), params: { aula: { edificio: @aula.edificio, numero_aula: @aula.numero_aula } }
